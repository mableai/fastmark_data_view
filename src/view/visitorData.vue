    ...
    <div class="echartsbox">
      ...
      <Row :gutter="12">
            ...
            <Col span="24">
              <div id="visitorsoure" class="visitorsoure bordshowColor">
                ...
                <div class="newsnot">{{newsnotice}}</div>
                  <div class="show" v-if="visitorsoureoptionshow">暂无数据</div>
              </div>
            </Col>

            <Col span="24">
              <div id="sex" class="sex bordshowColor mt">
                <common-echart :option="sexption" height="350px"></common-echart>
                <div class="newsnot">{{newsnotice}}</div>
                 <div class="show" v-if="sexptionshow">暂无数据</div>
              </div>
            </Col>
          </Row>
        </Col>
        <Col span="12">
          <Row>
            <Col span="24">
              <div id="terminal" class="terminal bordshowColor ">
                <common-echart :option="terminaloption" height="350px"></common-echart>
                <div class="newsnot">{{newsnotice}}</div>
                 <div class="show" v-if="terminaloptionshow">暂无数据</div>
              </div>
            </Col>
            <Col span="24">
              <div id="timequantum" class="timequantum bordshowColor mt">
                <common-echart :option="timequantumoption" height="425px"></common-echart>
                <div class="newsnot">{{newsnotice}}</div>
                 <div class="show" v-if="timequantumoptionshow">暂无数据</div>
              </div>
            </Col>
          </Row>
        </Col>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        // self:this,
        visitorsoureoptionshow:false,
        sexptionshow:false,
        terminaloptionshow:false,
        timequantumoptionshow:false,
        columns1: [
          {
            title: '省份',
            key: 'name',
    ...
    watch: {
      businessList: {
        handler(newValue, oldValue) {
          console.log('监听访客数据页面的businessList----', newValue)
            ...
            if (res.head.code == "0") {
              ...
              console.log("省份", newprovinces);
                      ...
                      this.citiesData = newcities;
                        ...
                        if(neworigins !==""){
                               this.visitorsoureoptionshow = !this.visitorsoureoptionshow;
                        }
                        if(newsex !==""){
                               this.sexptionshow = this.sexptionshow;
                        }
                        if(newdevices !==""){
                               this.terminaloptionshow = this.terminaloptionshow;
                        }
                        if(newtimeSope !==""){
                               this.timequantumoptionshow = !this.timequantumoptionshow;
                        }
            }
          })
        });
